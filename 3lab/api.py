...
class RequestMeta(type):
    def __new__(cls, name, bases, namespace):
        fields = {filed_name: field for filed_name, field in namespace.items() if isinstance(field, Field)}
...
def method_handler(request, ctx, store):
    handlers = {"online_score": OnlineScoreHandler, "clients_interests": ClientsInterestsHandler}
